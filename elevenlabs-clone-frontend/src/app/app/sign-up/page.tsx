          ...
          <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#0f1322]/80 backdrop-blur-xl p-8 shadow-2xl">
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Get unlimited access to AI voice generation & cloning
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              >
                {isLoading ? "Setting up Studio..." : "Create Account & Start"}
              </button>
        ...
        <div className="h-full w-full rounded-3xl bg-gradient-to-br from-indigo-950/60 via-[#101426] to-purple-950/60 border border-white/10 p-12 flex flex-col justify-between relative overflow-hidden shadow-2xl">
          ...
          <div className="max-w-md">
            <h3 className="text-3xl font-extrabold text-white tracking-tight leading-tight mb-4">
              All-In-One AI Audio Creation Suite
            </h3>
            <p className="text-sm text-gray-300 leading-relaxed mb-6">
              Unlock the complete creative audio studio with unlimited text-to-speech, voice cloning, sound effects, and voice transformation.
            </p>

            <div className="flex flex-col gap-3">
              {[
                "Unlimited Free Voice Generations",
                "Instant Voice Cloning via Mic or Upload",
                "Cinematic Sound Effects & Presets",
                "High Quality WAV Download & Storage",
              ].map((feat) => (
