...
const defaultVoices: Voice[] = [
  ...
  {
    id: "adam",
    name: "Adam (Deep & Dominant)",
    gradientColors: GRADIENT_COLORS[2]!,
    service: "styletts2",
    description: "ElevenLabs classic deep, authoritative male narrator",
  },
  {
    id: "antoni",
    name: "Antoni (Warm & Articulate)",
    gradientColors: GRADIENT_COLORS[3]!,
    service: "styletts2",
    description: "ElevenLabs balanced, expressive male voice for storytelling",
  },
  {
    id: "josh",
    name: "Josh (Young & Casual)",
    gradientColors: GRADIENT_COLORS[4]!,
    service: "styletts2",
    description: "ElevenLabs natural, conversational American male voice",
  },
  {
    id: "woman",
  ...
  },
  {
    ...
    gradientColors: GRADIENT_COLORS[2]!,
    service: "seedvc",
    description: "Acoustic clone model for Adam",
  },
  {
    id: "antoni",
    name: "Antoni (Articulate Storyteller)",
    gradientColors: GRADIENT_COLORS[3]!,
    service: "seedvc",
    description: "Acoustic clone model for Antoni",
  },
  {
    id: "josh",
    name: "Josh (Casual Voice)",
    gradientColors: GRADIENT_COLORS[4]!,
    service: "seedvc",
    description: "Acoustic clone model for Josh",
  },
  {
    id: "woman",
